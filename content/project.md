...
<img src="../public/images/homepage_project1.webp" alt="project1" class="w-1/2 float-left" />

**Wetとは、バイオの研究において、実際に生物を用いて実験する部分のこと**を指します。  
...
当団体のWetでは、**実験計画を立てるところから研究室での実験、データの収集まで、学生メンバーが主体となって研究**を進めています。
...
<img src="../public/images/homepage_project2.png" alt="project2" class="w-1/2 float-left" />
...
<img src="../public/images/homepage_project3.png" alt="project3" class="w-1/2 float-left" />
...
<img src="../public/images/homepage_project4.png" alt="project4" class="w-1/2 float-left" />
<img src="../public/images/homepage_project5.png" alt="project5" class="w-1/2 float-left" />
...
<img src="../public/images/homepage_project6.png"/>

**Dryとは、バイオ研究においてコンピュータ上で理論設計や解析を行う分野**を指します。  
...
当団体のDryでは、学生は**主に自主的な学習によって、計画立案からモデルの構築、シミュレーションの解析までに必要なスキルを獲得し、試行錯誤を繰り返しながらプロジェクトを進めています**。

## モデルの構築

<img src="../public/images/homepage_project7.png" alt="project7" class="w-1/2 float-left" />
...
<img src="../public/images/homepage_project8.png" alt="project8" class="w-1/2 float-left" />
<img src="../public/images/homepage_project9.png" alt="project9" class="w-1/2 float-left" />
...
<img src="../public/images/homepage_project10.jpg" alt="project10" class="w-1/2 float-left" />

**Human Practiceとは、研究や技術を社会との関係の中で捉え、より良い形で実装するための活動**を指します。  
...
<img src="../public/images/homepage_project11.png" alt="project11" class="w-1/2 float-left" />

**Wiki制作では、iGEMの大会において、プロジェクトの成果をまとめたウェブページ「Wiki」を作成し、、インターネットを通じて世界に発信**します。
...
<img src="../public/images/homepage_project12.png" alt="project12" class="w-1/2 float-left" />
...
HTML・CSS・TypeScriptなどの言語を用いて、サイトの骨組み、デザイン、アニメーションをWikiに反映させます。  
...
<img src="../public/images/homepage_project13.png" alt="project13" class="w-1/2 float-left" />
...
<img src="../public/images/homepage_project14.jpg" alt="project14" class="w-1/2 float-left" />

**広報活動では、iGEMやiGEM Kyotoの取り組みについて専門外の方にも分かりやすく伝え、合成生物学やiGEMについて興味を持ってもらうとともに、社会の方々と関わりを持つことを目的**としています。
...
iGEMへの参加や研究活動には、**試薬費や機材費、参加費など多くの費用が必要**です。  
そのため当団体では、**企業・団体・個人の方々からの支援を受けながら活動**しています。

生物学やプロジェクトに関係する企業、地元京都の団体などにコンタクトを取り、当団体の活動についてご紹介し、スポンサーとなっていただいています。  
